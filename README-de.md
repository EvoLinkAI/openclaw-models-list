...
> Eine kuratierte Liste erstklassiger KI-Modelle, mit einsatzbereiten Konfigurationen für OpenClaw.
...
Dieses Repository listet wichtige KI-Modelle auf, die für die Integration mit OpenClaw verfügbar sind, geordnet nach Anbieter. Jedes Modell enthält eine Konfigurationsdatei mit Anweisungen zum Kopieren und Einfügen.
...
### Schritt 3: Standardmodell festlegen

```bash
openclaw models set <provider>/<model-id>
```

### Schritt 4: Neustarten & Überprüfen
...
📖 Vollständiges Einrichtungs-Handbuch: [docs.evolink.ai](https://docs.evolink.ai/en/integration-guide/openclaw?utm_source=github&utm_medium=readme&utm_campaign=openclaw-models-list)
