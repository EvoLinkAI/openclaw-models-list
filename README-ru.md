...
2. **API-ключ** от вашего предпочтительного поставщика.
...
Отредактируйте `~/.openclaw/openclaw.json` и настройте выбранного поставщика. Подробности о схеме см. в [документации](https://docs.openclaw.ai).
