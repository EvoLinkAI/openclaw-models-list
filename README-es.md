...
2. **API Key** de su proveedor preferido.
...
Edite `~/.openclaw/openclaw.json` y configure su proveedor elegido. Consulte la [documentación](https://docs.openclaw.ai) para obtener detalles del esquema.
